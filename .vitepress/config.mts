          ...
          items: [
            ...
            },
            {
              ...
              items: [
                ...
                { text: "<div style='color: #4b4949;'>Classes, structs</div>", link: "/book/tutor/classes" },
                { text: "<div style='color: #4b4949;'>Generics</div>", link: "/book/tutor/generics" },
                { text: "<div style='color: #4b4949;'>Polymorphism</div>", link: "/book/tutor/polymorphism" },
                ...
                { text: "<div style='color: #4b4949;'>CUDA and computed shaders</div>", link: "/book/tutor/cuda" },
              ],
            }
          ],
        }
